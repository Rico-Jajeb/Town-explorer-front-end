...
import Sidebar from '@/components/AdminPage/Layout/Sidebar.vue'
import Header from '@/components/AdminPage/Layout/Header.vue'
...
<template>
  <main class="bg-red-300 flex fle-row relative">
